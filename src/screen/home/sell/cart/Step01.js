...
export default class Step01View extends Component {
    ...
    render() {
        ...
        console.log('typeMoney: ' + this.state.typeMoney)
        return (
            <ScrollView style={{ width: '100%', flex: 1, backgroundColor: color.HOME.bgColorHome }}>
                ...
                <View style={{ paddingHorizontal: 10, width: '100%', }}>
                    ...
                    <Text style={{ color: color.mainColor, fontSize: values.fontSizeTitle, fontWeight: '500' }}>{numeral(Sell.infoCart.price).format('0,0') + ' ' + Sell.infoCart.unit}</Text>
