    ...
    render() {
        ...
        return (
            ...
            < View style={{ backgroundColor: '#fff', width: '100%', borderRadius: 8, alignItems: 'center', }}>
                <View style={{ width: '100%', backgroundColor: 'transparent', paddingHorizontal: 30, }}>
                    <Text style={{ fontSize: values.fontSizeTitle, width: '100%', fontWeight: 'bold', color: '#000', textAlign: 'center', paddingVertical: 7 }}>DANH SÁCH MÁY IN</Text>
                </View>
                <FlatList
                    style={{ paddingHorizontal: 10, width: '100%', minWidth: 300, borderTopColor: '#ccc', borderTopWidth: 0.5, }}
